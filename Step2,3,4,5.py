...
listOfWalkingData = []
listOfWalkingData.append(df1)
listOfWalkingData.append(df2)
listOfWalkingData.append(df3)
listOfWalkingData.append(df4)
listOfWalkingData.append(df5)
listOfWalkingData.append(df6)
...
listOfJumpingData.append(df7)
listOfJumpingData.append(df8)


lisfOfCombinedData = listOfWalkingData + listOfJumpingData
# print(lisfOfCombinedData)
...
# fpr,tpr,_ = roc_curve(y_test, y_prob[:,1],pos_label=dtc.classes_[1])
