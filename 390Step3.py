...
# Plot acceleration vs. time for a sample of walking and jumping data FILTERED 
df = walking_data_df
Q1 = df.quantile(0.30)
Q3 = df.quantile(0.70)
IQR = Q3 - Q1
...
#Total acceleration over time for a window
fig, ax = plt.subplots(nrows=2, ncols=1, figsize=(10, 10))
ax[0].plot(dfWalk.iloc[1000:2000, 1], label='x')
ax[0].plot(dfWalk.iloc[1000:2000, 2], label='y')
ax[0].plot(dfWalk.iloc[1000:2000, 3], label='z')
ax[0].set_ylabel('Acceleration (m/s^2)')
ax[0].set_title('Walking Acceleration vs. Time')
ax[0].legend()

ax[1].plot(dfJump.iloc[1000:2000, 1], label='x')
ax[1].plot(dfJump.iloc[1000:2000, 2], label='y')
ax[1].plot(dfJump.iloc[1000:2000, 3], label='z')
...
# XYZ axes acceleration for a window
fig, ax = plt.subplots(nrows=2, ncols=1, figsize=(10, 10))
